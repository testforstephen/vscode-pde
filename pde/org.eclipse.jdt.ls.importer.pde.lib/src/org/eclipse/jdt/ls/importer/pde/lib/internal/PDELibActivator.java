...
package org.eclipse.jdt.ls.importer.pde.lib.internal;
...
public class PDELibActivator implements BundleActivator {

	public static final String PLUGIN_ID = "org.eclipse.jdt.ls.importer.pde.lib";
	...
	public void start(BundleContext bundleContext) throws Exception {
		PDELibActivator.context = bundleContext;
	}

	@Override
	public void stop(BundleContext bundleContext) throws Exception {
		PDELibActivator.context = null;
	}
